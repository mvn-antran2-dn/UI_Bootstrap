    ...
    <>
      ...
      <div className="container">
        <div className="content-all">
          <nav id="navbar-example2" className="navbar navbar-light bg-light px-3 flex justify-content-between">
            <a className="navbar-brand" href="#scrollspy-heading1">
              Navbar
            </a>
            <ul className="nav nav-pills flex align-items-center">
      ...
      <div className="container">
        <div className="content-all flex ">
          <nav id="navbar-example3" className="navbar navbar2 navbar-light bg-light flex-column col-4">
            <a className="navbar-brand" href="/#">
              Navbar
            </a>
            <nav className="nav nav2 nav-pills flex flex-column">
              <a ref={item1} className=" nav-link2 active" href="#item-1">
                Item 1
              </a>
              <nav className=" nav nav-item2 nav-pills flex flex-column">
          ...
          <div ref={scrollspyVer} className="scrollspy-example nested ex-2 ml-2 mt-2 col-8">
      ...
      <div className="container">
        <div className="content-all flex ">
          <div id="list-example" className="list-group example-list-group col-3 flex flex-column">
          ...
          <div ref={scrollspyListG} className="scrollspy-example ex-list-group ml-2 col-8">
            <h4 className="heading-scroll3" id="list-item-1">
              Item 1
            </h4>
            <p>
              First heading This is some placeholder content for the scrollspy
            ...
            <h4 className="heading-scroll3" id="list-item-2">
              Item 2
            </h4>
            <p>
              First heading This is some placeholder content for the scrollspy
            ...
            <h4 className="heading-scroll3" id="list-item-3">
              Item 3
            </h4>
            <p>
              First heading This is some placeholder content for the scrollspy
            ...
            <h4 className="heading-scroll3" id="list-item-4">
              Item 4
            </h4>
